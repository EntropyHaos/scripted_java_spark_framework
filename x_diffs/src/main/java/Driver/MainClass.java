...
public class MainClass {
    ...
    private void init() {
    	...
    	userMod.createUser("benHaos", "Ben", "Jon", "Haos", 43, 'M', "4142021234", 12345);
    	userMod.createUser("entHaos", "Joe", "Jack", "Henry", 18, 'M', "1234567890", 54321);
        ...
        post("/createUser", (request, response) -> {
            ...
            try {
                ...
                if(userMod.checkUser(u.getId())) {
                    int id = userMod.createUser(u.getId(), u.getFirstName(), u.getMiddleName(), u.getLastName(),
        ...
        post("/updateUser", (request, response) -> {
            ...
            try {
                ...
                if(!userMod.checkUser(u.getId())) {
                    int id = userMod.updateUser(u.getId(), u.getFirstName(), u.getMiddleName(), u.getLastName(),
                    u.getAge(), u.getGender(), u.getPhone(), u.getZip());
                    response.status(200);
                    response.type("application/json");
                    return id;
